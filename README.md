...
> **Project location:** The Spring Boot application lives in the [`ecom-proj`](ecom-proj/) folder. After cloning, run all Maven commands from inside `ecom-proj/`.
...
- **Java 21** or later  
- **Maven 3.6+** (or use the included Maven Wrapper in `ecom-proj/`)
...
```bash
git clone https://github.com/srinithreddy16/Ecommerce_Backend.git
cd Ecommerce_Backend/ecom-proj
```
...
Key settings in `ecom-proj/src/main/resources/application.properties`:
